...
app = FastAPI(
    ...
    description="Streamlined Vulnerability Intelligence Platform with AI-powered analysis",
    version="1.0.0"
)
...
from app.routes.v1 import advisory_routes, intelligence_routes, query_routes

app.include_router(advisory_routes.router, prefix="/api/v1", tags=["Advisory Remediation"])
app.include_router(intelligence_routes.router, prefix="/api/v1", tags=["Intelligence"])
...
async def root():
    ...
    return {
        ...
        "version": "1.0.0",
        "description": "Streamlined vulnerability intelligence platform",
        "endpoints": {
            "docs": "/docs",
            ...
            "query_advisory": "/api/v1/query/advisory/{advisory_id}",
            "query_cve": "/api/v1/query/cve/{cve_id}",
            "query_product": "/api/v1/query/product/{product_name}"
        }
    }
